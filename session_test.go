...
var (
	...
	SavedIpAddress     string = "10.10.10.100" // TODO should do a DNS lookup of Conf.HttpsHost for this
...
func Test_Config(t *testing.T) {
	...
	if Conf.Smtp.User != "fromster@mailbot.net" {
		t.Fatalf("FAIL: Smtp.User had an unexpected value")
	}

	if Conf.Smtp.Password != "from me from me" {
		t.Fatalf("FAIL: Smtp.Password had an unexpected value")
	}

	if Conf.Smtp.EmailFrom != "fromster@mailbot.net" {
